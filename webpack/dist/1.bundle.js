...
/***/ function(module, exports, __webpack_require__) {
	...
	var Requester = __webpack_require__(4),
	    Displayer = __webpack_require__(5);

	module.exports = function Theme(container, theme, key) {
		...
		_createClass(Displayer, [{
			...
			value: function display() {
				...
				this.items.forEach(function (item) {
					return HTML += _this.createItem(item);
				});
				//I don't like usage of innerHTML, but need to show ES6 templating
				this.container.innerHTML = HTML;
				setTimeout(function (e) {
					return _this.container.classList.add('show');
				}, 0);
			}
		}, {
			key: 'createItem',
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./topStories.css", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./topStories.css");
